...
class TestConvert:
    ...
    @pytest.mark.parametrize("dst_compat", [
        pytest.param(
            "0.10",
            marks=pytest.mark.xfail(reason="qemu-img allocates entire image"),
        ),
        "1.1"
    ])
    def test_qcow2_backing_file_without_creation(self, user_mount, dst_compat):
        virtual_size = MiB
        # Create source chain.
    ...
    def test_qcow2_collapsed_without_creation(self, user_mount, dst_compat):
        virtual_size = MiB
