...
class CheckService(object):
    ...
    def stop_checking(self, path, timeout=None):
        """
        Stop checing path. If timeout is set, wait until the cheker has
...
class DirectioChecker(object):
    ...
    def _check(self):
        ...
        This starts a dd process performing direct I/O to path, reading the
        process stderr. When stderr has closed, _read_completed will be called.
        """
